...
export default function Footer({ page }) {
  return (
    <>
      <section
        class="page-section-pb mt-50"
        style={{ background: "rgb(37, 31, 50)" }}
      >
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div
                ...
                style={{ borderRadius: "12px", background: "#46CDD0" }}
              >
                <h6 class="lacks-heading d-none">Lacks Heading</h6>
                <div class="row">
                  <div
                    class="col-md-6 sm-mb-10"
